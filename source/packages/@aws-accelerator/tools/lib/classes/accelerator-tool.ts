...
export class AcceleratorTool {
  ...
  private pipelineStageActions: {
  ...
  }[] = [
    {
      ...
      order: 7,
      actions: [
        { order: 13, name: 'Finalize', stackPrefix: '-FinalizeStack' },
        { order: 12, name: 'Customizations', stackPrefix: '-CustomizationsStack' },
        { order: 11, name: 'Customizations', stackPrefix: '-ResourcePolicyEnforcementStack' },
        { order: 10, name: 'Network_Associations', stackPrefix: '-NetworkAssociationsStack' },
        { order: 9, name: 'Network_Associations', stackPrefix: '-NetworkAssociationsGwlbStack' },
        { order: 8, name: 'Security_Resources', stackPrefix: '-SecurityResourcesStack' },
        { order: 7, name: 'Identity_Center', stackPrefix: '-IdentityCenterStack' },
        { order: 6, name: 'Network_VPCs', stackPrefix: '-NetworkVpcDnsStack' },
        { order: 5, name: 'Network_VPCs', stackPrefix: '-NetworkVpcEndpointsStack' },
        { order: 4, name: 'Network_VPCs', stackPrefix: '-NetworkVpcStack' },
        { order: 3, name: 'Operations', stackPrefix: '-OperationsStack' },
        { order: 2, name: 'Security', stackPrefix: '-SecurityStack' },
