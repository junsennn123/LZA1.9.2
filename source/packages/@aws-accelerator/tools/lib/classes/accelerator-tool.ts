  ...
  private pipelineStageActions: {
  ...
  }[] = [
    {
      ...
      actions: [
        ...
        { order: 9, name: 'Network_Associations', stackPrefix: '-NetworkAssociationsStack' },
        { order: 8, name: 'Network_Associations', stackPrefix: '-NetworkAssociationsGwlbStack' },
        { order: 7, name: 'Security_Resources', stackPrefix: '-SecurityResourcesStack' },
